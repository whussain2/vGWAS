...
***
## **Epistatic Interaction Effective Plot**
***

* Here we are providing the sample codes used to draw interaction effective plot (Figure 5 of the manuscript)

```{r, eval=FALSE}
# Read the data file
epis<-read.csv(file="~/Documents/GitHub/vGWAS/Data/Raw_data/epistasis_effectiveplot_DATA.csv", header=TRUE)
